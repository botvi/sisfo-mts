                ...
                <form action="{{ route('gambars.update', $gambar->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="title" name="title"
                            value="{{ $gambar->title }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="description" class="form-label">Description</label>
                        <textarea class="form-control" id="description" name="description" required>{{ $gambar->description }}</textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if ($gambar->image)
                            <img src="{{ asset($gambar->image) }}" alt="Image" class="img-fluid mt-2"
