...
<div class="container-xxl pt-5">
    <div class="container">
        ...
        {{-- Check if alamat and asal_sekolah are empty --}}
        @if(empty(Auth::user()->alamat) || empty(Auth::user()->asal_sekolah))
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                Anda belum melengkapi alamat atau asal sekolah. Silakan lengkapi informasi tersebut sebelum melanjutkan.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
            <div class="text-center">
                <a href="{{ route('profile') }}" class="btn btn-warning">Lengkapi Profil</a>
            </div>
        @else
            <div class="row">
